...
class Renderer_a5ad586e197e0b60e589b89e10425246facd9085 extends \s9e\TextFormatter\Renderers\PHP
{
	...
	/** {@inheritdoc} */
	protected $quickRegexp='(<(?:(?!/)((?:HR|IMG|UPL-(?:FILE|IMAGE(?:-PREVIEW)?|TEXT-PREVIEW)))(?: [^>]*)?>.*?</\\1|(/?(?!br/|p>)[^ />]+)[^>]*?(/)?)>)s';
	/** {@inheritdoc} */
